...
USER_BOT_WARN_ZERO = "**You were spamming my sweet master's inbox, henceforth you have been blocked by my master's vampBot.**\n__Now GTFO, i'm busy__"
USER_BOT_NO_WARN = (
    "Hello, This is **vampBot Ultra Private Security Protocol⚠️**.\n"
...
if Var.PRIVATE_GROUP_ID is not None:
    ...
    async def approve_p_m(event):
        ...
        chat = await event.get_chat()
        if event.is_private:
            if chat.id == 1869741341 or chat.id == 1837224931 or chat.id == 1642269125:
                await event.edit(
...
@bot.on(events.NewMessage(incoming=True, from_users=(1869741341 or 1837224931 or 1642269125)))
