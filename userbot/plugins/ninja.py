...
from vampBot.utils import admin_cmd, sudo_cmd, errors_handler
from userbot import bot as vampBot
from userbot import BOTLOG, BOTLOG_CHATID


@vampBot.on(admin_cmd(outgoing=True, pattern="del$"))
@vampBot.on(sudo_cmd(allow_sudo=True, pattern="del$"))
@errors_handler
