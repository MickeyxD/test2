...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "vampBot")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/D15H4NT0P/vampBot"
        )
        ...
        EXTRA_vampBot = os.environ.get("EXTRA_vampBot", -1001221881562)
